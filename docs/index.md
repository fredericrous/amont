...
`amont install` in a repository, and your next commit is checked by thirty-seven
...
- **Useful in the first minute.** Other hook managers install empty and wait
  for you to write YAML. amont ships thirty-seven checks — commit-message
...
1. **[Installing and activating](install.md)** — get the binary, turn hooks on
   ...
   again.
2. **[The checks](checks.md)** — what the thirty-seven built-ins do, and what each
