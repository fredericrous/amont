...
`amont install` in a repository, and your next commit is checked by twenty-eight
...
- **Useful in the first minute.** Other hook managers install empty and wait
  for you to write YAML. amont ships twenty-eight checks — commit-message
...
1. **[Installing and activating](install.md)** — get the binary, turn hooks on
   ...
   again.
2. **[The checks](checks.md)** — what the twenty-eight built-ins do, and what each
