...
- **Useful in the first minute.** Twenty-eight built-in checks — commit-message
...
Twenty-eight built-in checks across five git hooks, plus any your repository declares
