...
- **Useful in the first minute.** Twenty-six built-in checks — commit-message
...
Twenty-six built-in checks across five git hooks, plus any your repository declares
